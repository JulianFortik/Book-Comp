...
"resource": {
  ...
  "macros":[{
      ...
      "function":"__jsm",
      "vtp_javascript":["template","(function(){var a=",["escape",["macro",74],8,16],";switch(a){case \"start\":return\"play\";case \"progress\":return\"\"+",["escape",["macro",75],8,16],"+\"%\"}})();"]
    },{
      "function":"__v",
      "vtp_dataLayerVersion":1,
      "vtp_setDefaultValue":true,
      ...
      "function":"__jsm",
      "vtp_javascript":["template","(function(){var a=",["escape",["macro",81],8,16],".closest(\"a[class^\\x3d'authLink']\");if(a)return a=a.text.split(\" \"),a[a.length-1].toLowerCase()})();"]
    },{
      "function":"__remm",
      "vtp_setDefaultValue":true,
      "vtp_input":["macro",0],
      ...
      "vtp_setDefaultValue":false,
      "vtp_input":["macro",74],
      "vtp_map":["list",["map","key","start","value","play"],["map","key","progress","value",["macro",75]]]
    },{
      "function":"__remm",
      "vtp_setDefaultValue":true,
      "vtp_input":["macro",0],
  ...
  "tags":[{
      ...
      "vtp_trackType":"TRACK_EVENT",
      "vtp_gaSettings":["macro",69],
      "vtp_eventAction":["template",["macro",73],"%"],
      "vtp_enableRecaptchaOption":false,
      "vtp_enableUaRlsa":false,
      "vtp_enableUseInternalVersion":false,
      "vtp_enableFirebaseCampaignData":true,
      ...
      "vtp_dimension":["list",["map","index","35","dimension",["macro",77]]],
  ...
  "rules":[
    ...
    [["if",1,47],["unless",48],["add",28]],
    [["if",1,49],["add",29]],
    [["if",1,50],["add",30]],
    [["if",1],["unless",51,52],["add",31]],
    [["if",25,27],["unless",51,52],["add",31]],
    [["if",35,53],["add",32]],
    [["if",8,54],["add",33]],
    [["if",1,55],["add",35]],
    ...
    [["if",12,44,46,68],["add",62]],
    [["if",1,70],["unless",69],["add",63,64]],
    [["if",1,71],["add",65,66]],
...
d,0))/g,1))*(1-Math.min((Math.max(0-e.top,0)+Math.max(e.bottom-c,0))/f,1)):0};var Rg=[],Sg=!(!A.IntersectionObserver||!A.IntersectionObserverEntry),Tg=function(a,b,c){for(var d=new A.IntersectionObserver(a,{threshold:c}),e=0;e<b.length;e++)d.observe(b[e]);for(var f=0;f<Rg.length;f++)if(!Rg[f])return Rg[f]=d,f;return Rg.push(d)-1},Ug=function(a,b,c){function d(h,l){var m={top:0,bottom:0,right:0,left:0,width:0,height:0},p={boundingClientRect:h.getBoundingClientRect(),
intersectionRatio:l,intersectionRect:m,isIntersecting:0<l,rootBounds:m,target:h,time:db()};N(function(){return a(p)})}for(var e=[],f=[],g=0;g<b.length;g++)e.push(0),f.push(-1);c.sort(function(h,l){return h-l});return function(){for(var h=0;h<b.length;h++){var l=Qg(b[h]);if(l>e[h])for(;f[h]<c.length-1&&l>=c[f[h]+1];)d(b[h],l),f[h]++;else if(l<e[h])for(;0<=f[h]&&l<=c[f[h]];)d(b[h],l),f[h]--;e[h]=l}}},Vg=function(a,b,c){for(var d=0;d<c.length;d++)1<c[d]?c[d]=1:0>c[d]&&(c[d]=0);if(Sg){var e=!1;N(function(){e||
Ug(a,b,c)()});return Tg(function(f){e=!0;for(var g={pb:0};g.pb<f.length;g={pb:g.pb},g.pb++)N(function(h){return function(){return a(f[h.pb])}}(g))},b,c)}return A.setInterval(Ug(a,b,c),1E3)},Wg=function(a){Sg?0<=a&&a<Rg.length&&Rg[a]&&(Rg[a].disconnect(),Rg[a]=void 0):A.clearInterval(a)};var Xg=/:[0-9]+$/,Yg=function(a,b,c,d){for(var e=[],f=a.split("&"),g=0;g<f.length;g++){var h=f[g].split("=");if(decodeURIComponent(h[0]).replace(/\+/g," ")===b){var l=h.slice(1).join("=");if(!c)return d?l:decodeURIComponent(l).replace(/\+/g," ");e.push(d?l:decodeURIComponent(l).replace(/\+/g," "))}}return c?e:void 0},ah=function(a,b,c,d,e){b&&(b=String(b).toLowerCase());if("protocol"===b||"port"===b)a.protocol=Zg(a.protocol)||Zg(A.location.protocol);"port"===b?a.port=String(Number(a.hostname?a.port:
...
Z.h.cl=["google"],function(){function a(b){var c=b.target;if(c){var d=go(c,"gtm.click");Xq(d)}}(function(b){Z.__cl=b;Z.__cl.i="cl";Z.__cl.m=!0;Z.__cl.priorityOverride=0})(function(b){if(!br("cl")){var c=S("document");gg(c,"click",a,!0);cr("cl")}N(b.vtp_gtmOnSuccess)})}();Z.h.k=["google"],function(){(function(a){Z.__k=a;Z.__k.i="k";Z.__k.m=!0;Z.__k.priorityOverride=0})(function(a){return Zq(a.vtp_name,Wq("gtm.cookie",1),!!a.vtp_decodeCookie)[0]})}();
...
Z.h.ytl=["google"],function(){function a(){var u=Math.round(1E9*Math.random())+"";return M.getElementById(u)?a():u}function b(u,v){if(!u)return!1;for(var w=0;w<p.length;w++)if(0<=u.indexOf("//"+p[w]+"/"+v))return!0;return!1}function c(u,v){var w=u.getAttribute("src");if(b(w,"embed/")){if(0<w.indexOf("enablejsapi=1"))return!0;if(v){var y=u.setAttribute,x;var z=-1!==w.indexOf("?")?"&":"?";if(-1<w.indexOf("origin="))x=w+z+"enablejsapi=1";else{if(!t){var B=S("document");t=B.location.protocol+"//"+B.location.hostname;
B.location.port&&(t+=":"+B.location.port)}x=w+z+"enablejsapi=1&origin="+encodeURIComponent(t)}y.call(u,"src",x);return!0}}return!1}function d(u,v){if(!u.getAttribute("data-gtm-yt-inspected-"+v.be)&&(u.setAttribute("data-gtm-yt-inspected-"+v.be,"true"),c(u,v.xf))){u.id||(u.id=a());var w=S("YT"),y=w.get(u.id);y||(y=new w.Player(u.id));var x=f(y,v),z={},B;for(B in x)z.qb=B,x.hasOwnProperty(z.qb)&&y.addEventListener(z.qb,function(C){return function(D){return x[C.qb](D.data)}}(z)),z={qb:z.qb}}}function e(u){N(function(){function v(){for(var y=
w.getElementsByTagName("iframe"),x=y.length,z=0;z<x;z++)d(y[z],u)}var w=S("document");v();Eq(v)})}function f(u,v){var w,y;function x(){ca=Pq(function(){return{url:J,title:X,tf:L,sh:u.getCurrentTime(),playbackRate:P}},v.be,u.getIframe());L=0;X=J="";P=1;return z}function z(U){switch(U){case n.PLAYING:L=Math.round(u.getDuration());J=u.getVideoUrl();if(u.getVideoData){var ma=u.getVideoData();X=ma?ma.title:""}P=u.getPlaybackRate();v.lh?ca.Dc("start"):ca.vd();ra=l(v.ii,v.hi,u.getDuration());return B(U);
default:return z}}function B(){ea=u.getCurrentTime();Ca=Sq().getTime();ca.ri();aa();return C}function C(U){var ma;switch(U){case n.ENDED:return F(U);case n.PAUSED:ma="pause";case n.BUFFERING:var Ia=u.getCurrentTime()-ea;ma=1<Math.abs((Sq().getTime()-Ca)/1E3*P-Ia)?"seek":ma||"buffering";u.getCurrentTime()&&(v.kh?ca.Dc(ma):ca.vd());O();return D;case n.UNSTARTED:return x(U);default:return C}}function D(U){switch(U){case n.ENDED:return F(U);case n.PLAYING:return B(U);case n.UNSTARTED:return x(U);default:return D}}
function F(){for(;y;){var U=w;Qq(y);U()}v.jh&&ca.Dc("complete",1);return x(n.UNSTARTED)}function K(){}function O(){y&&(Qq(y),y=0,w=K)}function aa(){if(ra.length&&0!==P){var U=-1,ma;do{ma=ra[0];if(ma.Ua>u.getDuration())return;U=(ma.Ua-u.getCurrentTime())/P;if(0>U&&(ra.shift(),0===ra.length))return}while(0>U);w=function(){y=0;w=K;0<ra.length&&ra[0].Ua===ma.Ua&&(ra.shift(),ca.Dc("progress",ma.Ff,ma.Jf));aa()};y=Rq(w,1E3*U)}}var ca,ra=[],L,J,X,P,ea,Ca,T=x(n.UNSTARTED);y=0;w=K;return{onStateChange:function(U){T=
T(U)},onPlaybackRateChange:function(U){ea=u.getCurrentTime();Ca=Sq().getTime();ca.vd();P=U;O();aa()}}}function g(u){for(var v=u.split(","),w=v.length,y=[],x=0;x<w;x++){var z=parseInt(v[x],10);isNaN(z)||100<z||0>z||y.push(z/100)}y.sort(function(B,C){return B-C});return y}function h(u){for(var v=u.split(","),w=v.length,y=[],x=0;x<w;x++){var z=parseInt(v[x],10);isNaN(z)||0>z||y.push(z)}y.sort(function(B,C){return B-C});return y}function l(u,v,w){var y=u.map(function(B){return{Ua:B,Jf:B,Ff:void 0}});
if(!v.length)return y;var x=v.map(function(B){return{Ua:B*w,Jf:void 0,Ff:B}});if(!y.length)return x;var z=y.concat(x);z.sort(function(B,C){return B.Ua-C.Ua});return z}function m(u){var v=!!u.vtp_captureStart,w=!!u.vtp_captureComplete,y=!!u.vtp_capturePause,x=g(u.vtp_progressThresholdsPercent+""),z=h(u.vtp_progressThresholdsTimeInSeconds+""),B=!!u.vtp_fixMissingApi;if(v||w||y||x.length||z.length){var C={lh:v,jh:w,kh:y,hi:x,ii:z,xf:B,be:void 0===u.vtp_uniqueTriggerId?"":u.vtp_uniqueTriggerId},D=S("YT"),
F=function(){e(C)};N(u.vtp_gtmOnSuccess);if(D)D.ready&&D.ready(F);else{var K=S("onYouTubeIframeAPIReady");Yq("onYouTubeIframeAPIReady",function(){K&&K();F()});N(function(){for(var O=S("document"),aa=O.getElementsByTagName("script"),ca=aa.length,ra=0;ra<ca;ra++){var L=aa[ra].getAttribute("src");if(b(L,"iframe_api")||b(L,"player_api"))return}for(var J=O.getElementsByTagName("iframe"),X=J.length,P=0;P<X;P++)if(!r&&c(J[P],C.xf)){R("https://www.youtube.com/iframe_api");r=!0;break}})}}else N(u.vtp_gtmOnSuccess)}
var p=["www.youtube.com","www.youtube-nocookie.com"],n={UNSTARTED:-1,ENDED:0,PLAYING:1,PAUSED:2,BUFFERING:3,CUED:5},t,r=!1;(function(u){Z.__ytl=u;Z.__ytl.i="ytl";Z.__ytl.m=!0;Z.__ytl.priorityOverride=0})(function(u){u.vtp_triggerStartOption?m(u):zk(function(){m(u)})})}();
...
Z.h.evl=["google"],function(){function a(){var f=Number(Wq("gtm.start"))||0;return Sq().getTime()-f}function b(f,g,h,l){function m(){if(!Og(f.target)){g.has(d.uc)||g.set(d.uc,""+a());g.has(d.pd)||g.set(d.pd,""+a());var n=0;g.has(d.wc)&&(n=Number(g.get(d.wc)));n+=100;g.set(d.wc,""+n);if(n>=h){var t=go(f.target,"gtm.elementVisibility",[g.g]),r=Qg(f.target);t["gtm.visibleRatio"]=Math.round(1E3*r)/10;t["gtm.visibleTime"]=h;t["gtm.visibleFirstTime"]=Number(g.get(d.pd));t["gtm.visibleLastTime"]=Number(g.get(d.uc));
Xq(t);l()}}}if(!g.has(d.Fb)&&(0==h&&m(),!g.has(d.jb))){var p=S("self").setInterval(m,100);g.set(d.Fb,p)}}function c(f){f.has(d.Fb)&&(S("self").clearInterval(Number(f.get(d.Fb))),f.o(d.Fb))}var d={Fb:"polling-id-",pd:"first-on-screen-",uc:"recent-on-screen-",wc:"total-visible-time-",jb:"has-fired-"},e=function(f,g){this.element=f;this.g=g};e.prototype.has=function(f){return!!this.element.getAttribute("data-gtm-vis-"+f+this.g)};e.prototype.get=function(f){return this.element.getAttribute("data-gtm-vis-"+
f+this.g)};e.prototype.set=function(f,g){this.element.setAttribute("data-gtm-vis-"+f+this.g,g)};e.prototype.o=function(f){this.element.removeAttribute("data-gtm-vis-"+f+this.g)};(function(f){Z.__evl=f;Z.__evl.i="evl";Z.__evl.m=!0;Z.__evl.priorityOverride=0})(function(f){function g(){var y=!1,x=null;if("CSS"===l){try{x=Kg(m)}catch(F){I(46)}y=!!x&&v.length!=x.length}else if("ID"===l){var z=M.getElementById(m);z&&(x=[z],y=1!=v.length||v[0]!==z)}x||(x=[],y=0<v.length);if(y){for(var B=0;B<v.length;B++){var C=
new e(v[B],r);c(C)}v=[];for(var D=0;D<x.length;D++)v.push(x[D]);0<=w&&Wg(w);0<v.length&&(w=Vg(h,v,[t]))}}function h(y){var x=new e(y.target,r);y.intersectionRatio>=t?x.has(d.jb)||b(y,x,n,"ONCE"===u?function(){for(var z=0;z<v.length;z++){var B=new e(v[z],r);B.set(d.jb,"1");c(B)}Wg(w);if(p&&Dq)for(var C=0;C<Dq.length;C++)Dq[C]===g&&Dq.splice(C,1)}:function(){x.set(d.jb,"1");c(x)}):(c(x),"MANY_PER_ELEMENT"===u&&x.has(d.jb)&&(x.o(d.jb),x.o(d.wc)),x.o(d.uc))}var l=f.vtp_selectorType,m;"ID"===l?m=String(f.vtp_elementId):
"CSS"===l&&(m=String(f.vtp_elementSelector));var p=!!f.vtp_useDomChangeListener,n=f.vtp_useOnScreenDuration&&Number(f.vtp_onScreenDuration)||0,t=(Number(f.vtp_onScreenRatio)||50)/100,r=f.vtp_uniqueTriggerId,u=f.vtp_firingFrequency,v=[],w=-1;g();p&&Eq(g);N(f.vtp_gtmOnSuccess)})}();
